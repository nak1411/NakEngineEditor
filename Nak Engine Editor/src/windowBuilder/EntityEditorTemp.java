...
public class EntityEditorTemp {

	private JFrame entityEditorPanel;
	...
	public void initialize() {
		entityEditorPanel = new JFrame("Nak Entity Editor");
		entityEditorPanel.getContentPane().setBackground(UIManager.getColor("Button.background"));
		...
		GroupLayout groupLayout = new GroupLayout(entityEditorPanel.getContentPane());
		...
		entityEditorPanel.setJMenuBar(menuBar);
		...
		entityEditorPanel.setVisible(true);
		entityEditorPanel.getContentPane().setLayout(groupLayout);
		entityEditorPanel.setBounds(0, 0, 1366, 720);
		entityEditorPanel.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
	}
}
