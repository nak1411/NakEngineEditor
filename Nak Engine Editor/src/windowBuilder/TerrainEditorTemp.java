...
public class TerrainEditorTemp {

	private JFrame terrainEditorPanel;
	...
	public void initialize() {
		terrainEditorPanel = new JFrame("Nak Terrain Editor");
		terrainEditorPanel.getContentPane().setBackground(UIManager.getColor("Button.background"));
		...
		GroupLayout groupLayout = new GroupLayout(terrainEditorPanel.getContentPane());
		...
		terrainEditorPanel.setJMenuBar(menuBar);
		...
		terrainEditorPanel.setVisible(true);
		terrainEditorPanel.getContentPane().setLayout(groupLayout);
		terrainEditorPanel.setBounds(0, 0, 1366, 720);
		terrainEditorPanel.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
	}
}
