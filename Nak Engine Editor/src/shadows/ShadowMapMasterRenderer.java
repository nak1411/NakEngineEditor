...
public class ShadowMapMasterRenderer {
	...
	private int pcfCount = 2;
	private float totalTexels;
	private float shadowOffset = 10;
	...
	public ShadowMapMasterRenderer(Camera camera) {
		totalTexels = (float) ((pcfCount * 2.0 + 1.0) * (pcfCount * 2.0 + 1.0));
		shader = new ShadowShader();
		shadowBox = new ShadowBox(lightViewMatrix, camera, this);
		shadowFbo = new ShadowFrameBuffer(shadowMapSize, shadowMapSize);
