...
public class ShadowBox {
	...
	private Camera cam;
	private ShadowMapMasterRenderer renderer;
	 ...
	 *            - the in-game camera.
	 */
	protected ShadowBox(Matrix4f lightViewMatrix, Camera camera, ShadowMapMasterRenderer renderer) {
	...
	protected void update() {
		...
		toFar.scale(renderer.getShadowDistance());
	...
	private void calculateWidthsAndHeights() {
		farWidth = (float) (renderer.getShadowDistance() * Math.tan(Math.toRadians(MasterRenderer.FOV)));
